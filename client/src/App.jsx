          ...
          {user ? (
            ...
            <>
              ...
              <NavLink
                to="/signup"
                className={({ isActive }) =>
                  `${base} ${isActive ? variants.primary : variants.primary}`
                }
              >
                Sign up
              </NavLink>
...
function Home() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 flex-1 flex items-center">
        ...
        <div className="flex flex-col p-10 md:p-16 items-center justify-center">
          <div className="flex flex-col justify-center text-center">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600 md:text-base">
              {user 
                ? `Welcome back, ${user.name}! Track your habits and build momentum.`
                : "Build lasting habits and track your progress. Login or sign up to get started."
              }
            </p>
...
export default function App() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-gray-900">
      <BrowserRouter>
        <Navbar />
        <Routes>
          {/* Public pages */}
